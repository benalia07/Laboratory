...
public class TeamStorage : ITeamStorage
{
    ...
    private const string insertTeamQuery = "Insert into dbo.Teams(TeamId, Status, LaboratoryId, TeamName, TeamAcronyme) VALUES(@aTeamId, @aStatus, @aLaboratoryId, @aTeamName ,@aTeamAcronyme)";
    ...
    public async Task InsertTeam(Team team)
    {
        ...
        cmd.Parameters.AddWithValue("@aTeamAcronyme", team.TeamAcronyme);
