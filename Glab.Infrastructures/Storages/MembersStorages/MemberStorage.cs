...
public class MemberStorage : IMemberStorage
{
    ...
    {
        SqlCommand cmd = new SqlCommand("INSERT INTO dbo.Members(MemberId, FirstName, LastName, Email,TeamId,status) " +
                                        "VALUES(@aMemberId, @aFirstName, @aLastName, @aEmail, @aTeamId,@aStatus)", connection);
